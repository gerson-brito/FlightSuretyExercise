...
contract FlightSuretyApp {
    ...
    uint8 airlineFundFee;                   // Airlines amount fee to register
    uint8 minAirlinesConsensus;          // Minimum airlines to be register to do the Consensus registration
    ...
    */
    ...
    function changeFundFee
                        ...
                        requireContractOwner
    {
        airlineFundFee = amount;
    }

    function changeMinAirlinesConsensus
                        (
                            uint8 numberAirlines
                        )
                        external
                        requireContractOwner
    {
        minAirlinesConsensus = numberAirlines;
    }
    ...
    */   
    function registerAirline
                            ...
                            requireAirlineIsNotRegistered(_airlineID)
                            
    {
        if (dataContract.registeredAirlineCount <= minAirlinesConsensus) {
            dataContract.registerAirline(_airlineName, _airlineID);
        } else {
            dataContract.addToWaitingAirlines(_airlineName, _airlineID);
            dataContract.voteForAirline(_airlineID);
        }
    }
    ...
    */  
    function registerFlight
                                ...
                                requireAirlineIsFunded(msg.sender)
    {
        dataContract.registerFlight(_airlineID, _flightCode, _timestamp);
    }
    ...
    */  
    ...
    function fundAirline
                        ...
                        payable
                        requireIsOperational
                        requireAirlineIsRegistered(airlineID)
                        requireAirlineIsNotFunded
    {
        require(msg.value >= airlineFundFee, "Fail to fund the Airline, not enough Ether");
        dataContract.fundAirline.value(msg.value)(airlineID, msg.value);
    }
